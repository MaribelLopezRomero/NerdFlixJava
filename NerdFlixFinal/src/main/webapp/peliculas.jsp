...
<html lang="en">
  <head>
    ...
    <title>Peliculas - NerdFlix</title>
...
.imagen {
  ...
  <main>
	...
	<!--   CODIGO JAVA  -->
     ...
     //OBJETO listaGenero con los generos que tengo en mi bbdd - METODO GETGENERO (Controller)
     LinkedList<Titulos> listaGeneros = Controller.getGeneros();
     
     //OBJETO listaPelicUlas con las peliculas de mi base de datos - METODO GETPELICULAS (Controller)
     LinkedList<Titulos> listaPeliculas = Controller.getPeliculas();	
      
     //BUCLE FOR - Recorra la lista de generos
     for  (int i=0; i<listaGeneros.size(); i++){
    	//Visualizamos cada genero
			...
			out.println(" <div id='wrapper'>");
				out.println(" <div class ='carousel'  id='carousel"+i+"'>");
					out.println(" <div class ='content'  id='content"+i+"'>");
						...
						//BUCLE FOR - Recorro la lista de las peliculas 
					    for (int j=0; j<listaPeliculas.size(); j++){
					   	 
						   	//sacamos el genero de cada Peliculas
						   	String genero =  listaPeliculas.get(j).getGenero(); 
						   	
						   	 //CONDICIONAL IF - Cuando el genero del for con el de la Peliculas coincida, se imprime
						   	 if (genero.equals(listaGeneros.get(i).getGenero())) { 
							   	 out.println ("<div class='item'>");
									out.println("<a href = 'playPeliculas.jsp?param="+listaPeliculas.get(j).getCod_titulo()+"&param2=pelicula'> <img class='imagen' src='"+ listaPeliculas.get(j).getImagen() +"'/> </a>");
								 out.println ("</div>");
						    }//fin bucle if
