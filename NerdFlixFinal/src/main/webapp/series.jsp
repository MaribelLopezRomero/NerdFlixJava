...
<%
  ...
  <main>
	...
	<!--   CODIGO JAVA  -->
     ...
     //OBJETO listaSeries con las series de mi base de datos - METODO GETSERIES (Controller)
			...
			out.println(" <div id='wrapper'>");
				out.println(" <div class ='carousel'  id='carousel"+i+"'>");
					out.println(" <div class ='content'  id='content"+i+"'>");
						...
						//BUCLE FOR - Recorro la lista de las series 
					    for (int j=0; j<listaSeries.size(); j++){
					   	 
						   	//sacamos el genero de cada serie
						   	String genero =  listaSeries.get(j).getGenero(); 
						   	
						   	 //CONDICIONAL IF - Cuando el genero del for con el de la serie coincida, se imprime
						   	 if (genero.equals(listaGeneros.get(i).getGenero())) { 
							   	 out.println ("<div class='item'>");
							   	out.println("<a href = 'playSeries.jsp?param="+listaSeries.get(j).getCod_titulo()+"&param2=serie'> <img class='imagen' src='"+ listaSeries.get(j).getImagen() +"'/> </a>");
								 out.println ("</div>");
						    }//fin bucle if
